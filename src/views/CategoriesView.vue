              ...
              <div class="p-6">
                ...
                >
                  <div class="relative">
                    <input
                      v-model="searchTerm"
                      @input="debouncedSearchCategorias"
                      type="text"
                  ...
                  <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                      ...
                      >
                        ...
                        >
                          <button
                            @click="openDeleteModal(categories)"
                ...
                <CreateCategoriesModal
                  ...
                  ref="CreateCategoriesModal"
                  @close="closeCreateModal"
                  @create-category="handleCategoryCreated"
                />
                <!-- Modal Edit User -->
                <EditCategoriesModal
                  v-if="selectedCategory && isEditModalOpen"
