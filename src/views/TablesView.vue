                    ...
                    <div class="max-w-full mx-auto">
                        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                            <div class="p-6">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <tr v-for="tables in tables" :key="tables.id_table">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <button @click="openEditModal(tables)"
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <button @click="openDeleteModal(tables)"
                                ...
                                <!-- Modal Create User -->
                                <CreateTablesModal :isOpen="isCreateModalOpen" ref="CreateTablesModal"
                                    @close="closeCreateModal" @create-tables="createTable" />
                                <!-- Modal Edit User -->
                                <EditTablesModal v-if="selectedTable && isEditModalOpen" :isOpen="isEditModalOpen"
                                    :tables="selectedTable" @close="closeEditModal" @submit-update="updateTables" />
                                <!-- Modal Delete User -->
                                <DeleteTableModal :isOpen="isDeleteModalOpen" :tables="selectedTable"
...
export default {
    ...
    methods: {
        ...
        openEditModal(tables) {
            ...
            this.selectedTable = { ...tables, id_table: tables.id_table, table_number: tables.table_number };
        ...
        async fetchTables(page = 1) {
            try {
                ...
                console.log("Users fetched:", this.tables);
            } catch (error) {
                console.error(
