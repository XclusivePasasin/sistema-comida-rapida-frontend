<template>
  ...
  >
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
      <h2 class="text-xl font-bold mb-4">Create Dish</h2>
...
,
    ...
    async validateDishName() {
      ...
      try {
        ...
        if (this.form.id_dish) {
          params.id = this.form.id_dish;
        }
    ...
    async submitForm() {
      ...
      if (
        ...
        this.$emit("create-dish", this.form);
        this.clearForm();
        this.closeModal();
      }
    },
